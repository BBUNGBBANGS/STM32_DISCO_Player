...
void LCD_Display_Init(void)
{
    ...
    BSP_LCD_DisplayStringAt(0, 5, (uint8_t *)"MP3 File List", CENTER_MODE);
    ...
    BSP_LCD_DisplayStringAt(7, 96, (uint8_t *)"3", LEFT_MODE);
    BSP_LCD_DisplayStringAt(7, 126, (uint8_t *)"4", LEFT_MODE);
    BSP_LCD_DisplayStringAt(7, 156, (uint8_t *)"5", LEFT_MODE);
    BSP_LCD_DisplayStringAt(7, 186, (uint8_t *)"6", LEFT_MODE);

    BSP_LCD_SetBackColor(LCD_COLOR_LIGHTBLUE);
    BSP_LCD_SetTextColor(LCD_COLOR_LIGHTBLUE);
    BSP_LCD_FillRect(0, 211, 160, 61);
    BSP_LCD_SetTextColor(LCD_COLOR_LIGHTYELLOW);
    BSP_LCD_DisplayStringAt(50, 232, (uint8_t *)"Play", LEFT_MODE);
    BSP_LCD_SetBackColor(LCD_COLOR_LIGHTGRAY);
    BSP_LCD_SetTextColor(LCD_COLOR_LIGHTGRAY);
    BSP_LCD_FillRect(160, 211, 160, 61);
    BSP_LCD_SetTextColor(LCD_COLOR_LIGHTYELLOW);
    BSP_LCD_DisplayStringAt(210, 232, (uint8_t *)"Stop", LEFT_MODE);
...
{     
    BSP_LCD_SetLayerAddress(LayerIndex,FB_Address);
